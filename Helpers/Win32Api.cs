...
namespace VivaldiUpdater.Helpers
{
    public static class Win32Api
    {
        ...
        internal static extern IntPtr FindWindowEx(IntPtr hwndParent, uint hwndChildAfter, string lpszClass,
            string lpszWindow);
        ...
        public static class IO
        {
            ...
            private static int SHFileOperation(FileFuncFlags flag, string sourceFileName, string destinationFileName,
                bool showDialog, bool showProgress, bool autoRename)
            {
                SHFILEOPSTRUCT lpFileOp = new SHFILEOPSTRUCT
                {
                    wFunc = flag,
            ...
            public static void DeleteFile(string fileName, bool toRecycle = false, bool showDialog = false,
